...
Syntax:
-s      Uses 7 bit chunks to make file permissions. No directories, any file/directory with somthing in the first 3 bits are ignored (allows for noise)

-t      Uses 10 bit chunks to make file permissions. Concats all permissions together. Leftover bits are 0 and ignored.

'python separate.py -s < hello.txt'
